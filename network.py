...
class Network():
    ...
    def __init__(self):
        ...
        self.optimiser = tf.keras.optimizers.SGD(0.00001, 0.9)
        self.minmax = TFMinMaxStats(self.N)
        self.update_count = 0
        ...
        observation = layers.Input([Network.input_size])
    ...
    def update_learning_rate(self, rate):
        self.optimiser.learning_rate = rate
